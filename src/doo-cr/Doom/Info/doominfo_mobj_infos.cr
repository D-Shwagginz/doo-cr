...
-1,                                                   # doomEdNum
        ...
        1000,                                         # spawnHealth
        MobjState::Nil,                               # seeState
        Sfx::NONE,                                    # seeSound
        8,                                            # reactionTime
        Sfx::NONE,                                    # attackSound
        MobjState::Nil,                               # painState
        0,                                            # painChance
        Sfx::NONE,                                    # painSound
        MobjState::Nil,                               # meleeState
        MobjState::Nil,                               # missileState
        MobjState::Nil,                               # deathState
        MobjState::Nil,                               # xdeathState
        Sfx::NONE,                                    # deathSound
        0,                                            # speed
        Fixed.from_i(20),                             # radius
