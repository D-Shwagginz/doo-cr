module Doocr
  module IVideo
    ...
    abstract def window_size=(@window_size : Int32) : Int32

    abstract def display_message : Bool
    abstract def display_message=(@display_message : Bool) : Bool

    abstract def max_gamma_correction_level : Int32
    abstract def gamma_correction_level : Int32
    abstract def gamma_correction_level=(@gamma_correction_level : Int32) : Int32
